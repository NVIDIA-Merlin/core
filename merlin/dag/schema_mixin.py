...
class ComputeSchemaMixin:
    """
    Adds the capability to compute input and output schemas to the classes it's mixed into
    """
    ...
    def output_dtype(self):
        """
        Overriding this method sets the output dtype on all output columns
        """
        return None
    ...
    def output_tags(self):
        """
        Overriding this method sets the output tags on all output columns
        """
        return []
    ...
    def output_properties(self):
        """
        Overriding this method sets the output properties on all output columns
        """
        return {}
