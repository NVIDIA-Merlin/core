...
import merlin  # noqa
from merlin.graph.schema_io.schema_writer_base import SchemaWriter  # noqa
from merlin.graph.tags import Tags  # noqa
...
class PbTxt_SchemaWriter(SchemaWriter):
    ...
    def load(cls, schema_path):
        ...
        return merlin.graph.Schema(columns)
