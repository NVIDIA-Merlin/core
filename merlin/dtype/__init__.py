...
int32 = DType(ElementType.Int, 32)
int64 = DType(ElementType.Int, 64)
float32 = DType(ElementType.Float, 32)
float64 = DType(ElementType.Float, 64)
string = DType(ElementType.String)
boolean = DType(ElementType.Bool)
